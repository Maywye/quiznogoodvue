    ...
    <div class="col-start-2 col-span-10 bg-[#F9F4F5] rounded-lg m-6 p-6 md:p-5 lg:row-start-1 lg:row-span-2 lg:col-start-8 lg:col-span-6 lg:m-12">
            <span>
                ...
                <form class="grid grid-cols-1 place-content-around md:mt-6 md:mb-24 md:mx-12">
                    ...
                    <input type="password" name="mdp" id="mdp" class="rounded-lg px-2 py-1.5 bg-[#C8B8DB] outline-[#502F4C] w-full lg:mb-5 md:py-3">
            ...
            <span class="grid grid-cols-1 pt-14">
                ...
                <a href="#" class="md:text-2xl">Supprimer le compte =(</a>
            </span>
    </div>
</template>
<script>
