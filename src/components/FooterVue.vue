<template>
        ...
        <div class="justify-between grid grid-cols-1 m-2 md:ml-10 md:mr-10 md:grid-cols-3">
            <div class="block md:text-start text-center content-center">
                <router-link class="hover:text-[#C8B8DB] md:p-2 text-sm" to="AboutUs">A Propos</router-link>
                <span> | </span>
                <router-link class="hover:text-[#C8B8DB] md:p-2 text-sm" to="CGU">CGU</router-link>
            </div> 
